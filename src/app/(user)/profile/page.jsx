                        ...
                        <div className="card-body">
                            ...
                            <form>
                                <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control" id="fullname" value="Nguyễn Văn A" />
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="email" className="form-label">
                                        Email
                                    </label>
                                    <input type="email" className="form-control" id="email" value="nguyenvana@example.com" />
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="phone" className="form-label">
                                        Số điện thoại
                                    </label>
                                    <input type="text" className="form-control" id="phone" value="0123456789" />
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="address" className="form-label">
                                        Địa chỉ
                                    </label>
                                    <input type="text" className="form-control" id="address" value="123 Đường ABC, TP.HCM" />
                                </div>
